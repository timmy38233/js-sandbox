 ...
 * @param {HTMLElement} container the container element to which the boxes are appended
 * @param {Number} n the number of boxes to generate
 */
 ...
 * @param {HTMLElement} container The container element which contains the boxes
 * @param {Number} n The number of boxes to display
 */
...
(function init(slider, container) {
    ...
    slider.addEventListener('input', (e) => displayBoxes(container, e.target.value));
